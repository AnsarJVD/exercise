...
Route::post('/exercise-1-artwork-version', [ArtworkController::class, 'ex1']);
...
Route::post('/exercise-7-inventory', [ArtworkController::class, 'ex7']);
Route::post('/exercise-8-shipment', [ArtworkController::class, 'ex8']);
Route::post('/exercise-9−webhook', [ArtworkController::class, 'ex9']);
Route::post('/exercise-10-quote-expiry', [ArtworkController::class, 'ex10']);
